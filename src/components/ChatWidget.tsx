    ...
    <>
      ...
      >
        {open ? (
          ...
          <img src="/logo-transparent.png" alt="Chat" className="h-10 w-10" />
        )}
      </button>

      {/* Chat Panel */}
      {open && (
        <div className="fixed bottom-24 right-6 z-50 flex w-96 flex-col rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900" style={{ height: "500px" }}>
          {/* Header */}
